...
public class HabStateBase {
   ...
   */
  public HabStateBase(@JsonProperty(JSON_PROPERTY_NAME) String name, @JsonProperty(JSON_PROPERTY_PREFIX) String prefix, @JsonProperty(JSON_PROPERTY_ICP_DT) String icpDt) {
    this.name = name;
    this.prefix = prefix;
    this.icpDt = icpDt;
  }
