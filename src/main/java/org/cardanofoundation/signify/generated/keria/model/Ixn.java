...
@JsonSubTypes({
    @JsonSubTypes.Type(value = IXNV2.class, name = "v"),
    @JsonSubTypes.Type(value = IXNV2.class, name = "t"),
    @JsonSubTypes.Type(value = IXNV2.class, name = "d"),
    @JsonSubTypes.Type(value = IXNV2.class, name = "i"),
    @JsonSubTypes.Type(value = IXNV2.class, name = "s"),
    @JsonSubTypes.Type(value = IXNV2.class, name = "p"),
    @JsonSubTypes.Type(value = IXNV2.class, name = "a")
})
