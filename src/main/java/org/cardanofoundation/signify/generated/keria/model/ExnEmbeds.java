...
@JsonSubTypes({
    @JsonSubTypes.Type(value = MultisigInceptEmbeds.class, name = "icp"),
    @JsonSubTypes.Type(value = MultisigExnEmbeds.class, name = "d"),
    @JsonSubTypes.Type(value = MultisigRotateEmbeds.class, name = "rot"),
    @JsonSubTypes.Type(value = MultisigInteractEmbeds.class, name = "ixn"),
    @JsonSubTypes.Type(value = MultisigRegistryInceptEmbeds.class, name = "vcp"),
    @JsonSubTypes.Type(value = MultisigIssueEmbeds.class, name = "acdc"),
    @JsonSubTypes.Type(value = MultisigIssueEmbeds.class, name = "iss"),
    @JsonSubTypes.Type(value = MultisigRevokeEmbeds.class, name = "rev"),
    @JsonSubTypes.Type(value = MultisigRpyEmbeds.class, name = "rpy"),
    @JsonSubTypes.Type(value = MultisigExnEmbeds.class, name = "exn")
})
