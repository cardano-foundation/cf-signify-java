...
@JsonPropertyOrder({
  ...
  HabStateOneOf2.JSON_PROPERTY_NAME,
  HabStateOneOf2.JSON_PROPERTY_PREFIX,
  HabStateOneOf2.JSON_PROPERTY_ICP_DT,
  HabStateOneOf2.JSON_PROPERTY_STATE,
  HabStateOneOf2.JSON_PROPERTY_TRANSFERABLE,
  HabStateOneOf2.JSON_PROPERTY_WINDEXES
})
@JsonTypeName("HabState_oneOf_2")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.16.0")
public final class HabStateOneOf2 implements HabState {
   ...
   */
  public HabStateOneOf2(@JsonProperty(JSON_PROPERTY_GROUP) GroupKeyState group, @JsonProperty(JSON_PROPERTY_NAME) String name, @JsonProperty(JSON_PROPERTY_PREFIX) String prefix, @JsonProperty(JSON_PROPERTY_ICP_DT) String icpDt, @JsonProperty(JSON_PROPERTY_STATE) KeyStateRecord state, @JsonProperty(JSON_PROPERTY_TRANSFERABLE) Boolean transferable, @JsonProperty(JSON_PROPERTY_WINDEXES) List<String> windexes) {
    this.group = group;
    this.name = name;
    this.prefix = prefix;
    this.icpDt = icpDt;
  ...
  public HabStateOneOf2 name(@jakarta.annotation.Nonnull String name) {
  ...
  public HabStateOneOf2 prefix(@jakarta.annotation.Nonnull String prefix) {
  ...
  public HabStateOneOf2 icpDt(@jakarta.annotation.Nonnull String icpDt) {
  ...
  public HabStateOneOf2 state(@jakarta.annotation.Nonnull KeyStateRecord state) {
  ...
  public HabStateOneOf2 transferable(@jakarta.annotation.Nonnull Boolean transferable) {
  ...
  public HabStateOneOf2 windexes(@jakarta.annotation.Nonnull List<String> windexes) {
    
    this.windexes = windexes;
    return this;
  }

  public HabStateOneOf2 addWindexesItem(String windexesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.group, habStateOneOf2.group) &&
        Objects.equals(this.name, habStateOneOf2.name) &&
        Objects.equals(this.prefix, habStateOneOf2.prefix) &&
        Objects.equals(this.icpDt, habStateOneOf2.icpDt) &&
        Objects.equals(this.state, habStateOneOf2.state) &&
        Objects.equals(this.transferable, habStateOneOf2.transferable) &&
        Objects.equals(this.windexes, habStateOneOf2.windexes);
  }
