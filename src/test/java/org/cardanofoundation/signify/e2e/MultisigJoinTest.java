...
public class MultisigJoinTest extends BaseIntegrationTest {
    ...
    public void multisigJoinTest() throws Exception {
        ...
        kargs.setMhab(aid1);
        kargs.setIsith(Sith.fromInteger(1));
        kargs.setNsith(Sith.fromInteger(1));
        ...
        iargs2.setMhab(aid2);
        iargs2.setIsith(Sith.fromObject(icp.get("kt")));
        iargs2.setNsith(Sith.fromObject(icp.get("nt")));
