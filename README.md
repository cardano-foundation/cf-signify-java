...
If download fails, it falls back to `spec.yaml` in the repo root. The generated sources are placed under `build/generated/src/main/java` and are automatically added to the `main` source set.
